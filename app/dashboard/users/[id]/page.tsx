    ...
    <div className="flex gap-4">
      ...
      <div className="flex flex-col w-3/4">
        <div>
          ...
          <Input type="text" name="username" placeholder="Sai Surya Teja" />
        </div>
        <div>
          <Label htmlFor="email">Email</Label>
          <Input type="text" name="email" placeholder="sst@gmail.com" />
        </div>
        <div>
          <Label htmlFor="phone">Phone</Label>
          <Input type="number" name="phone" placeholder="9123456789" />
        </div>
        <div>
          <Label htmlFor="password">Password</Label>
          <Input type="text" name="password" placeholder="Test@123" />
        </div>
        <div>
          <Label htmlFor="address">Email</Label>
          <Textarea name="address" placeholder="XYZ Street, Z road." />
        </div>
        <div>
