    ...
    <div className="flex gap-4">
      ...
      <div className="flex flex-col w-3/4">
        <div>
          ...
          <Input type="text" name="title" placeholder="Sai Surya Teja" />
        </div>
        <div>
          <Label htmlFor="price">Price</Label>
          <Input type="text" name="price" placeholder="sst@gmail.com" />
        </div>
        <div>
          <Label htmlFor="stock">Stock</Label>
          <Input type="number" name="stock" placeholder="9123456789" />
        </div>
        <div>
          <Label htmlFor="color">Color</Label>
          <Input type="text" name="color" placeholder="Test@123" />
        </div>
        <div>
          <Label htmlFor="size">Size</Label>
          <Input type="number" name="size" placeholder="Test@123" />
        </div>
        <div>
          <Label htmlFor="description">Description</Label>
          <Textarea name="description" placeholder="XYZ Street, Z road." />
        </div>
        <div>
